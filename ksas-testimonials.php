...
function define_testimonialtype_terms() {
	...
	$terms = array(
		'0' => array(
			'name' => 'internship',
			'slug' => 'internship-testimonial',
		),
		'1' => array(
			'name' => 'alumni',
			'slug' => 'alumni-testimonial',
		),
	);
...
class Testimonial_Widget extends WP_Widget {
	public function __construct() {
		$widget_options  = array(
			'classname'   => 'ksas_testimonial',
			'description' => __( 'Displays a random testimonial', 'ksas_testimonial' ),
		);
		$control_options = array(
			'width'   => 300,
			'height'  => 350,
			'id_base' => 'ksas_testimonial-widget',
		);
	...
	public function form( $instance ) {
		...
		$defaults = array(
			'title'           => __( 'Testimonial', 'ksas_testimonial' ),
			'category_choice' => '1',
			'random'          => 'rand',
			'link'            => '',
		);
	...
	public function widget( $args, $instance ) {
		...
		global $post;
		$testimonial_widget_query = new WP_Query(
			array(
		...
		if ( $testimonial_widget_query->have_posts() ) :
			while ( $testimonial_widget_query->have_posts() ) :
				$testimonial_widget_query->the_post();
				?>
		...
		<article aria-label="<?php echo $category_choice; ?> archives">
			<p class="view-more-link"><a href="<?php echo ( esc_url( $archive_link ) ); ?>">View more Testimonials <span class="fa fa-chevron-circle-right" aria-hidden="true"></span></a></p>
		</article>
	<?php endif;
		echo $after_widget;
	}
